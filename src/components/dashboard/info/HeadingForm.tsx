...
const formSchema = z.object({
    heading: z.string().min(1, { message: "Tagline is required" })
});

const HeadingForm = ({ initialData, userId }: HeadingFormProps) => {
        ...
        <div className="mt-6 border bg-slate-100 dark:bg-gray-900 rounded-md p-4">
            ...
            {!isEditing && (
                <p className="text-sm mt-2" >
                    {initialData?.heading || "No tagline"}
                </p>
            )}
            {isEditing && (
                <Form {...form} >
                                ...
                                <FormItem>
                                    <FormControl>
                                        <Input
                                            ...
                                            placeholder="e.g. 'Hey! Welcode To My Portfolio.'"
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormMessage />
